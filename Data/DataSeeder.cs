    ...
    public static class DataSeeder
    {
        public static async Task SeedDataAsync(VoyagerDbContext context)
        {
            ...
            if (!context.CampaignLocations.Any())
            {
                ...
                {
                    new CampaignLocation { TenantId = tenantId, LocationName = "Boracay, Aklan", Description = "World-famous white sand beaches", Latitude = 11.9674m, Longitude = 121.9248m, Country = "Philippines" },
                    new CampaignLocation { TenantId = tenantId, LocationName = "El Nido, Palawan", Description = "Stunning limestone cliffs and lagoons", Latitude = 11.1955m, Longitude = 119.4185m, Country = "Philippines" },
                    new CampaignLocation { TenantId = tenantId, LocationName = "Siargao, Surigao", Description = "The surfing capital of the Philippines", Latitude = 9.8500m, Longitude = 126.1167m, Country = "Philippines" }
                };
            ...
            if (!context.Campaigns.Any())
            {
                ...
                context.Campaigns.AddRange(new List<Campaign>
                {
                    new Campaign
                    {
                        ...
                        // ImageUrl = "https://images.unsplash.com/photo-1580541631971-a2066a30f5d6?auto=format&fit=crop&w=1200&q=80",
                        Budget = 25000,
